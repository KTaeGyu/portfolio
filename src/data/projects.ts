...
export const projects: Project[] = [
  {
    ...
    points: [
      '기존에는 시스템마다 학사 DB에 직접 붙어 있어, 표 하나가 바뀌면 어디가 깨지는지 아무도 몰랐다',
  ...
  },
  {
    ...
    points: [
      '자산 관리 · 채용 등 개별로 만들어져 있던 업무를 공통 화면 규칙 위로 다시 구현',
  ...
  },
  {
    ...
    role: '설계 · 구축',
    points: [
      '시스템끼리 인증과 API 로 얽혀 있어 한 대만 띄워서는 화면이 뜨지 않던 문제를 해결',
